...
export default new Vuex.Store({
  state: {
    ...
    blogPhotoFile: null, // Agregado para almacenar el archivo
    editPost: null,
    user: null,
    profileEmail: null,
  ...
  mutations: {
    ...
    setBlogState(state, payload) {
      ...
      state.blogTags = Array.isArray(payload.tags) ? payload.tags.join(', ') : payload.tags || '';
    },
    ...
    // Nueva mutación para guardar el archivo
    setBlogPhotoFile(state, payload) {
